...
-- Q.2 Write a SQL query to retrieve all transactions where the category is 'Clothing' and the quantity sold is or more than 4 in the month of Nov-2022
...
SELECT 
  customer_id, 
  highest_sales,
  ROW_NUMBER() OVER (ORDER BY highest_sales DESC) AS rank
FROM (
  SELECT 
    customer_id, 
